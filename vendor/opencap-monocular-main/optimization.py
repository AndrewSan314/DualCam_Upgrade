...
def run_optimization(
    ...
    save_trimmed_video = save_video_debug
    ...
    if run_opensim_original_wham:
        if utils_opensim is None:
            raise ImportError("OpenSim is required for run_opensim_original_wham=True")
    ...
    try:
        if run_opensim_opt2:
            if utils_opensim is None:
                raise ImportError("OpenSim is required for run_opensim_opt2=True")
